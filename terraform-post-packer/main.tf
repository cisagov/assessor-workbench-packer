...
# The Assessor Workbench Docker image only supports x86_64.
# The IDs of all ARM64 cisagov/assessor-workbench-packer AMIs
...
#   filter {
#     name   = "name"
#     values = ["assessor-workbench-hvm-*-arm64-ebs"]
#   }
#
#   filter {
...
# The IDs of all x86-64 cisagov/assessor-workbench-packer AMIs
data "aws_ami_ids" "historical_amis_x86_64" {
  ...
  filter {
    name   = "name"
    values = ["assessor-workbench-hvm-*-x86_64-ebs"]
  }

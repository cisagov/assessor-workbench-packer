...
issue](https://github.com/cisagov/assessor-portal-packer/issues) in this
...
request](https://github.com/cisagov/assessor-portal-packer/pulls), you will
...
```console
cd assessor-portal-packer
pyenv virtualenv <python_version_to_use> assessor-portal-packer
pyenv local assessor-portal-packer

...
issue](https://github.com/cisagov/assessor-workbench-packer/issues) in this
...
request](https://github.com/cisagov/assessor-workbench-packer/pulls), you will
...
```console
cd assessor-workbench-packer
pyenv virtualenv <python_version_to_use> assessor-workbench-packer
pyenv local assessor-workbench-packer
